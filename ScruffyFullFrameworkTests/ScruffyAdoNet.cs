...
public static class ScruffyAdoNet
{
    public static IList<T> Query<T>(this DbConnection connection, string sql, params DbParameter[] parameters) where T : new()
    {
    ...
    public static async Task<IList<T>> QueryAsync<T>(this DbConnection connection, CancellationToken cancellationToken, string sql,
